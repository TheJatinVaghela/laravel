...
<body>
    ...
    <form class="container mt-5" action="{{route('submit_addNewcruduser')}}" method="post">
        @csrf
        <div class="row">
            <div class="mb-3 col">
                <label for="name" class="form-label fw-bold">Name :- </label>
                <input name="user_name" type="text" class="form-control" aria-describedby="willrememberyou_name"/>
                <div id="willrememberyou_name" class="form-text">We Will Know</div>
            </div>
            <div class="mb-3 col">
                <label for="email" class="form-label fw-bold">Email :- </label>
                <input name="user_email" type="email" class="form-control" aria-describedby="willrememberyou_email"/>
        ...
        <div class="row">
            <div class="mb-3 col">
                ...
                <input name="user_city" type="city" class="form-control" aria-describedby="willrememberyou_city"/>
                <div id="willrememberyou_city" class="form-text">We Will know where you live</div>
            </div>
            <div class="mb-3 col">
                <label for="age" class="form-label fw-bold">Age :- </label>
                <input name="user_age" type="age" class="form-control" aria-describedby="willrememberyou_age"/>
